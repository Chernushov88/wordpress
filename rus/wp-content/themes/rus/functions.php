...
function twentyseventeen_setup() {
	...
	$starter_content = array(
		'widgets'     => array(
			...
			'sidebar-partners' => array(
				'text_business_info',
			),
			'sidebar-contactInformation' => array(
				'text_business_info',
			),
		),
...
function twentyseventeen_widgets_init() {
	...
	register_sidebar(
		array(
			'name'          => __( 'Sidebar-info', 'twentyseventeen' ),
			'id'            => 'sidebar-info',
			'description'   => __( 'Add widgets html', 'twentyseventeen' ),
			'before_widget' => '',
			'after_widget'  => '',
			'before_title'  => '',
			'after_title'   => '',
	...
	register_sidebar(
		array(
			'name'          => __( 'Sidebar-partners', 'twentyseventeen' ),
			'id'            => 'sidebar-partners',
			'description'   => __( 'Add html widgets here to appear in your Наши партнеры.', 'twentyseventeen' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
			'before_title'  => '<h2 class="widget-title">',
			'after_title'   => '</h2>',
	...
	register_sidebar(
		array(
			'name'          => __( 'Sidebar-contactInformation', 'twentyseventeen' ),
			'id'            => 'sidebar-contactInformation',
			'description'   => __( 'Add html widgets here to appear in your Контактная информация.', 'twentyseventeen' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
			'before_title'  => '<h2 class="widget-title">',
			'after_title'   => '</h2>',
...
<span class="date-post"><?php printf(__('%1$s'), get_comment_date()) ?></span></h3>
...
<!-- <div class="comment-meta commentmetadata">
	<a href="<?php echo htmlspecialchars( get_comment_link( $comment->comment_ID ) ) ?>"><?php printf(__('%1$s at %2$s'), get_comment_date(), get_comment_time()) ?></a><?php edit_comment_link(__('(Edit)'),'  ','') ?>
					...
					<!-- <div class="comment-options">
						<div class="comment-button-bid">
							<a class="spanButton" href="#">Ответить</a>
						</div>
						<div class="reaction">
							<a class="like"><i class="fa fa-thumbs-up" aria-hidden="true"></i> 54</a>
							<a class="dislike"><i class="fa fa-thumbs-down" aria-hidden="true"></i>36</a>
						</div>
					</div> -->
					<hr>
				</div>
