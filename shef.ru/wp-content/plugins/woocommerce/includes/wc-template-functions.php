...
echo '</div><div class="hit_text"><div class="one_hit_ttl"><a href="'.esc_url( $link ).'" class="' . esc_attr( apply_filters( 'woocommerce_product_loop_title_classes', 'woocommerce-loop-product__title test' ) ) . '">' . get_the_title() . '</a></div><div class="hit_descr">' . get_the_excerpt() . '</div>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
}
}
...
if ( ! function_exists( 'woocommerce_template_loop_product_link_open' ) ) {
	...
	function woocommerce_template_loop_product_link_open() {
		...
		echo '<div class="hit_img"><a href="' . esc_url( $link ) . '">';
	}
}
