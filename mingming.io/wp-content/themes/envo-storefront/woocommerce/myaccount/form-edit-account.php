...
?>
 ...
 <div class="form-group">
    ...
    <div class="input-group">
    	<input type="text" name="handle" value="<?=$han?>" placeholder="@jimmybuffet" id="handle" class="form-control"></div>
  </div>
  <div class="form-group">
...
<!--   <div id="su3" style="display:none">Success</div> -->
 ...
 <div class="form-group">
    ...
    <div class="input-group">
    	<input type="text" name="birthday" value="<?=$bir?>" placeholder="99/99/9999" id="birthday" class="form-control"></div>
  </div>
  <div class="form-group">
