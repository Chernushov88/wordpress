          ...
          <h2><?php esc_html_e( 'Login', 'woocommerce' ); ?></h2>
	        ...
	        <div class="form-login">
	          ...
	          <form class="form-signin woocommerce-form woocommerce-form-login " method="post">
	            ...
	            <div class="form-group">
	            	<?php wp_nonce_field( 'woocommerce-login', 'woocommerce-login-nonce' ); ?>
	            	<button type="submit" class="btn btn-login btn-block" name="login" value="<?php esc_attr_e( 'Log in', 'woocommerce' ); ?>">Log In with email</button>
	            </div>
	            <?php do_action( 'woocommerce_login_form_end' ); ?>
	          </form>
	          <div class="">
	            <span>
	              By signing up, you agree to http://pozdr.beget.tech's<!-- --> <a href="/terms">Terms of Service</a> <!-- -->and<!-- --> <a href="/privacy">Privacy Policy</a>
	            </span>
	          </div>
	          <div style="margin-top:25px"><a href="/my-account-2/lost-password/">Forgot your password?</a></div>
