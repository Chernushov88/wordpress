        ...
        <tr>
          ...
          <td>
            <?
              ...
              {
              ?>
            <a target="_blank" href="/wp-content/uploads/<?=$link?>">This video</a>
            <?
              }
              ?>
          </td>
      ...
      <form id="spi" enctype="multipart/form-data"  class="form-horizontal col-md-12"  method="post" >
        <div class="form-group">
          <div class="input-group input-addFile">
            ...
            <label for="addVideo" class="form-control"><span  id="addVideoSpan"></span><a class="btn btn-primary btn-addFile">Add file</a></label>
            <input type="hidden" name="zak" id="zak" value="" >
          </div>
        </div>
        <div class="form-group">
...
<script>
  ...
  function validate() {
    ...
    function sen(){
      ...
      fd.append('link',jQuery('#addVideoSpan').val());
      zak.append('zak',jQuery('#zak').val());
