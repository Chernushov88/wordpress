...
<div class="md-visible">
  ...
  <div class="user-navigation">
    <ul class="nav">
      ...
      <li>
        <a  href="javascript:void(0);" onclick="ShowPopup('#balancesAccount')" >
      ...
      <li>
        <a href="javascript:void(0);" onclick="ShowPopup('#popupUserRole')" );>
      ...
      <li>
        <a href="javascript:void(0);" onclick="ShowPopup('#popupWriting')">
...
<div id="balancesAccount" class="popup">
  <div class="close" onclick="HidePopup('#balancesAccount');"><img width="20px" height="20px" src="/wp-content/themes/envo-storefront/img/close-white.svg" alt="Close"></div>
  <div class="modal-content" role="document">
    <div class="modal-header">
      <div class="form-group" style=" margin: 0 0 10px;">
        <h3 class="modal-title"><label >帐户结余</label></h3>
      </div>
    </div>
