<?php
  /*
   * Template name: verstpa-pages-sm
   */
...
<div class="site-content-sm-p-0">
  ...
  <div class="h1">NEWMING PHONE myorder</div>
  <div class="sm-visible enroll-celebrity-sm">
    <div class="enroll-celebrity-sm-in">
      <div class="accordion-wrapper">
        <div class="celebrity-accordion">
        ...
        <div class="celebrity-accordion active">
          <div class="celebrity-accordion-title">
            <div class="date">15.08.2020</div>
            <span>｜</span>
            <div class="processing">生日</div>
          ...
          <div class="celebrity-accordion-footer">
            <a href="#">封锁</a> <span>｜</span><a href="#">拒绝</a>
          </div>
        </div>
        <div class="celebrity-accordion">
          <div class="celebrity-accordion-title">
  ...
  <div class="h1">NEWMING PHONE myacc</div>
  ...
  <div class="h1">NEWMING PHONE ranking</div>
  <div class="sm-visible">
    <div class="user-head">
      <div class="user-head-img"><img src="/wp-content/themes/envo-storefront/img/sm/user-img.jpg" alt=""></div>
      <div class="user-head-name">
