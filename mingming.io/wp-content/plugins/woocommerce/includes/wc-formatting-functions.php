...
function wc_price( $price, $args = array() ) {
	...
	//$formatted_price = ( $negative ? '-' : '' ) . sprintf( $args['price_format'], '<span class="woocommerce-Price-currencySymbol leebel">' . get_woocommerce_currency_symbol( $args['currency'] ) . '</span>', $price );
	$formatted_price = ( $negative ? '-' : '' ) . sprintf( $args['price_format'], '<span class="woocommerce-Price-currencySymbol leebel"><img src="/wp-content/themes/envo-storefront/img/s.png" alt=""></span>', $price );
