    ...
    <div class="col-lg-4 col-md-5 hidden-sm hidden-xs col-sidebar" data-testid="booking-page-faq-section">
      <div class="sidebar-booking">
        ...
        <div class="block-img">
          ...
          <p>
            When your request is completed,<!-- --> <b>we'll email and text you</b> a link to view, share, or download your Cameo.
          </p>
        </div>
        <div class="block-img">
...
<style>
          ...
          <div class="form-group-in">
            <button onclick="send()" id="order-submit-button" type="button" style="margin-bottom:8px" class="btn btn-primary btn-danger">
              <span>
        ...
        <div class="">
          <p>
            By booking, you agree to posdr<!-- --> <a href="/terms">Terms of Service</a> and<!-- --> <a href="/privacy">Privacy Policy</a>
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="modal-body">
      <form class="form-horizontal col-md-12">
        <div class="form-group">
          <div class="input-group"><input name="promo" placeholder="cameorulez2017" type="text" id="promo" class="form-control" value="" required></div>
        </div>
        <div class="form-group">
