...
[Getting Started with Customer Reviews for WooCommerce](https://help.cusrev.com/support/solutions/articles/43000051291-getting-started-tutorial)
...
6. A Trust Badge block to showcase a summary of verified reviews.
7. A button to attach pictures to reviews.
8. reCAPTCHA field to prevent fake reviews.
9. A customer review with a picture.
10. [cusrev_reviews_slider] shortcode to display a responsive reviews slider on any page or post of a website
11. [cusrev_all_reviews] shortcode to display reviews for all products on any page or post of a website
12. [cusrev_reviews_grid] shortcode to display a grid of product reviews on any page or post of a website
13. The first settings page.
14. The second settings page.
15. The third settings page.
16. The fourth settings page.
17. The fifth settings page.
18. The sixth settings page.
19. WooCommerce Orders page with manual reminders option enabled.
20. The diagnostic page.
21. Import reviews page.
