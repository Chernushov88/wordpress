...
<div class="psfw-slider-inner-wrap" data-post_id="<?php echo $product_item_id; ?>" data-shortcode_id="<?php echo $post_id; ?>">
    <div class="psfw-container-wrapper">
        ...
        if ( isset( $psfw_option[ 'psfw_slider_template' ] ) && $psfw_option[ 'psfw_slider_template' ] != '' ) {
            include (PSFW_PATH . '/inc/frontend/template/slider/'. $psfw_option['psfw_slider_template'].'.php'); 
        } else {
            include (PSFW_PATH . '/inc/frontend/template/slider/template-1.php');
        }
        ?>
    </div>
    <?php include (PSFW_PATH . '/inc/frontend/data/lightbox-content.php'); ?>
</div>