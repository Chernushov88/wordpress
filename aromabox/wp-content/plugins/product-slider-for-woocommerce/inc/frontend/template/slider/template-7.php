...
<div class="psfw-top-wrap psfw-hidden" <?php echo $inline_css; ?>>
        ...
        <div class="psfw-detail-inner-wrap psfw-hidden">
            ...
            if (isset( $psfw_option[ 'psfw_show_content' ] ) && $psfw_option[ 'psfw_show_content' ] == '1' ) { ?>
                <div class="psfw-content">
                    <?php echo $this -> psfw_fetch_content($product_item_id, $psfw_option[ 'psfw_post_excerpt' ] ); ?>
                </div>
                <?php
            }
            ...
            <div class="psfw-below-wrap">
                ...
                <div class="psfw-social-outer-wrap">
                    <i class="fa fa-share-alt" aria-hidden="true"></i> <?php
