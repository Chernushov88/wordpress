...
<div class="psfw-circle-content psfw-hidden">
    ...
    <div class="psfw-top-wrap ">
        <div class="psfw-content-container">
            ...
            ?>
            <div class="psfw-buttons-collection psfw-clearfix" data-id="<?php echo $product_item_id; ?>"> 
                <div class="psfw-buttons-collection-primary"><?php
                ...
                <div class="psfw-buttons-collection-secondary">
