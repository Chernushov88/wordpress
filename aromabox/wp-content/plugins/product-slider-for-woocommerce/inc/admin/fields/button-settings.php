...
<div class="psfw-post-option-wrap">
    <label for="button-one-link" class="psfw-button-one-link"><?php _e( 'Call To Action Button One Link', PSFW_TD ); ?></label>
    ...
    <div class="psfw-tooltip-icon">
        ...
        <span class="psfw-tooltip-info"><?php _e( 'This is used to show the individual custom link for call to action button one', PSFW_TD ); ?></span>
    </div>
</div>
<div class="psfw-post-option-wrap">
    <label for="custom-button-link" class="psfw-custom2-link"><?php _e( 'Call To Action Button Two Link', PSFW_TD ); ?></label>
    <div class="psfw-post-field-wrap">
    ...
    <div class="psfw-tooltip-icon">
        <span class="dashicons dashicons-info"></span>
        <span class="psfw-tooltip-info"><?php _e( 'This is used to show the individual custom link for call to action button two', PSFW_TD ); ?></span>
    </div>
</div>

<div class="psfw-post-option-wrap">
    <label for="swap-image" class="psfw-swap-setting"><?php _e( 'Upload Swap on Hover Image', PSFW_TD ); ?></label>
    <div class="psfw-post-field-wrap">
        ...
        ?>" />
        <input type="button" class="psfw-swap-image-url-button button-secondary" name="psfw_swap_image"  value="<?php _e( 'Upload Image', PSFW_TD ); ?>" size="25"/>
    ...
    <div class="psfw-tooltip-icon">
        <span class="dashicons dashicons-info"></span>
        <span class="psfw-tooltip-info"><?php _e( 'This is used to show the swap image for Swap On Hover animation type.', PSFW_TD ); ?></span>
    </div>
</div>
