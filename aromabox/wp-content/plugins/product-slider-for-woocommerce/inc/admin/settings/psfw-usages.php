...
<div  class="psfw-shortcode-usage-wrapper">
    <ul class="psfw-usage-tab-wrap">
        <li data-usage="tab-1" class="psfw-usage-trigger psfw-usage-active">
            <?php _e( 'Shortcode', PSFW_TD ); ?>
        </li>
        <li data-usage="tab-2" class="psfw-usage-trigger">
            <?php _e( 'Template Include', PSFW_TD ); ?>
        </li>
    </ul>
    <div class="psfw-usage-post" data-usage-ref="tab-1">
        <p class="description"><?php _e( 'Copy and paste the shortcode directly into any WordPress post or page.', PSFW_TD ) ?></p>
    ...
    <div class="psfw-usage-post" data-usage-ref="tab-2" style="display: none;">
        <p class="description"><?php
            _e( 'Copy and paste this code into a template file to include the Product Slider For WooCommerce within your theme.', PSFW_TD );
            ?></p>
