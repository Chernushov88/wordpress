...
if ($tax_type == 'multiple-taxonomy') {
    if ($select_tax == 'select') {
        ?>
        <option value = "select" ><?php echo _e('Choose Terms', PSFW_TD);
        ?></option>
        <?php
    } else {
        ?>
        <option value = "select" ><?php echo _e('Choose Terms', PSFW_TD); ?></option>
        <?php
...
if ($tax_type == 'simple-taxonomy') {
    if ($select_tax == 'select') {
        ...
        ?>
        <option value = "select" ><?php echo _e('Choose Term', PSFW_TD); ?></option>
        <?php
