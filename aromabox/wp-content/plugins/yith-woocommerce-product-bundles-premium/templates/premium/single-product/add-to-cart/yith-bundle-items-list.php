        ...
        >
            ...
            <td class="yith-wcpb-product-bundled-item-data">
                ...
                <h3 class="yith-wcpb-product-bundled-item-data__title">
                    ...
                    if ($bp_sku){
                        $item_permalink  = get_permalink($bp_sku );
                        
                    } else{
                      $item_permalink  = $bundled_product->get_permalink();
                    }
                    
                    ?>
                    
                        <a href="<?php echo $item_permalink   ?>" class="<?php echo $quick_view_for_bundled_items ? 'yith-wcqv-button' : '' ?>" data-product_id="<?php echo $bundled_product->get_id() ?>">
							<?php echo $item_title ?>
                        </a>
					<?php else: ?>
						<?php echo $item_title ?>
