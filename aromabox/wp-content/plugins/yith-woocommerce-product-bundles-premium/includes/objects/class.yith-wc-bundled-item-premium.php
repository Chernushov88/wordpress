...
if ( ! class_exists( 'YITH_WC_Bundled_Item' ) ) {
	...
	class YITH_WC_Bundled_Item {
		...
		public function __construct( $parent, $item_id ) {
			...
			$this->discount            = isset( $parent->bundle_data[ $item_id ]['bp_discount'] ) ? floatval( $parent->bundle_data[ $item_id ]['bp_discount'] ) : 0;
	...
	$this->bp_sku            = isset( $parent->bundle_data[ $item_id ]['bp_sku'] ) ? $parent->bundle_data[ $item_id ]['bp_sku'] : 0;
