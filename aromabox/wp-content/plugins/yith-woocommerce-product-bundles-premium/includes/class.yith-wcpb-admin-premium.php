    ...
    class YITH_WCPB_Admin_Premium extends YITH_WCPB_Admin {
        ...
        public function yith_wcpb_admin_product_bundle_data( $metabox_id, $product_id, $item_data, $post_id ) {
            ...
            if ( $b_prod = wc_get_product( $product_id ) ) {
                ...
                $bp_sku = isset( $item_data[ 'bp_sku' ] ) ? $item_data[ 'bp_sku' ] : '';
                ...
                <div class="options_group">
                    ...
                    <p class="form-field select2-selection select2-selection--multiple">
                        <label><?php echo _ex( 'Add product if need', 'Admin: the title of the bundled product.', 'yith-woocommerce-product-bundles' ); ?></label>
                        <input type="text" name="_yith_wcpb_bundle_data[<?php echo $metabox_id; ?>][bp_sku]" class="yith-wcpb-bp-name yith-wcpb-bp select2-search__field" value="<?php echo $bp_sku; ?>">
                        <?php echo yith_wcpb_help_tip( __( 'Choose product.', 'yith-woocommerce-product-bundles' ) ); ?>
                    </p>
