...
class Alg_WC_Products_Per_Page_Core {
	...
	function add_products_per_page_form() {
		...
		$options      = array_map( 'trim', explode( PHP_EOL,
			apply_filters( 'alg_wc_products_per_page_select_options', '12|12' . PHP_EOL . '24|24' . PHP_EOL . '48|48' .PHP_EOL . 'Все|-1' ) ) );
		...
		$html .= '<form class="woocommerce-ordering" action="' . get_pagenum_link() . '" method="POST">';
